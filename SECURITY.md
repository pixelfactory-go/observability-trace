...
1. **GitHub Security Advisories** (Preferred): Use the [Security Advisory](https://github.com/pixelfactory-go/observability-trace/security/advisories/new) feature to privately report vulnerabilities
...
- Inject malicious content (e.g., trace injection attacks)
- Compromise the integrity of observability data
...
- The observability-trace library and all its components
...
- **GitHub**: https://github.com/pixelfactory-go/observability-trace/security/advisories
